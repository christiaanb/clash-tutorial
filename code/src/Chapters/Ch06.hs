-- | The reader's @src/Example/Project.hs@ at the end of chapter 6.
--
-- Chapters 2 to 5 are unchanged. What is new is the first clocked thing in the
-- tutorial: one register, holding a board, fed by that board's own next
-- generation. The design now runs by itself, one generation per cycle.
