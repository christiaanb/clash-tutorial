-- | The reader's @src/Example/Project.hs@ at the end of chapter 5.
--
-- Chapters 2 to 4 are unchanged. What is new is one line: a generation of Life,
-- the cell rule from chapter 2 applied to the counts from chapter 4. It is
-- still combinational; the clock arrives in chapter 6.
